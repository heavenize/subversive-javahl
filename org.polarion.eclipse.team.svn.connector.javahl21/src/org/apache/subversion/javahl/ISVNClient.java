...
public interface ISVNClient
{
     ...
     * @param onDisk      Request status information from working copy.
     ...
     * @param depthAsSticky if set, make the operation depth sticky
     * @param changelists changelists to filter by
     */
    void status(String path, Depth depth, boolean onServer, boolean onDisk,
                boolean getAll, boolean noIgnore, boolean ignoreExternals,
                boolean depthAsSticky, Collection<String> changelists, 
     ...
     * @param patterns        optional patterns to filter entries
     * @param depth           the depth to recurse into subdirectories
     * @param direntFields    the fields to retrieve
     * @param fetchLocks      whether to fetch lock information
     * @param includeExternals whether to include externals
    ...
    /**
     * Lists a directory (with older ListCallback interface for compatibility).
     * @param url The URL of the directory to list
     * @param revision The revision to list
     * @param pegRevision The peg revision
     * @param depth The depth of the listing
     * @param direntFields Which fields to retrieve
     * @param fetchLocks Whether to fetch lock information
     ...
     * @param depth     the depth to recurse into subdirectories
     * @param changelists changelists to filter by
     * @param clearChangelists clear changelists after revert
     * @param metadataOnly only revert metadata changes
     * @throws ClientException
     */
    void revert(Set<String> paths, Depth depth, Collection<String> changelists,
                boolean clearChangelists, boolean metadataOnly)
            throws ClientException;
    ...
    void add(String path, Depth depth, boolean force, boolean noIgnores,
             boolean noAutoProps, boolean addParents)
        throws ClientException;
